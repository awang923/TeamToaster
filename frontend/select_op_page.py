...
class SelectOperationPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        load_button = Button(self, text="Load/Unload",
                             command=lambda: on_load_click(), height=3, width=20)
        load_button.place(relx=.25, rely=.2, anchor=CENTER)
        balance_button = Button(
            self, text="Balance", command=lambda: on_balance_click(), height=3, width=20)
